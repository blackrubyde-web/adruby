...
const UI = {
  ...
  card: 'rounded-2xl border border-border/60 bg-card/80 backdrop-blur-md shadow-sm hover:border-border hover:bg-card/90 transition',

  cardHeader: 'flex items-center justify-between border-b border-border/70 px-4 py-3',

  cardBody: 'p-4',

  pill: 'rounded-full border border-border bg-card/80 text-foreground px-3 py-2 text-sm hover:bg-accent/20 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/60',

  pillActive: 'border-primary bg-primary/20 text-foreground shadow-sm',

  buttonPrimary: 'inline-flex h-10 items-center gap-2 rounded-lg bg-primary px-4 text-primary-foreground font-semibold shadow-sm hover:bg-primary/90 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60',

  buttonSecondary: 'inline-flex h-10 items-center gap-2 rounded-lg border border-border bg-card px-4 text-foreground hover:bg-accent/20 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/60',

  buttonGhost: 'inline-flex h-10 items-center gap-2 rounded-lg px-3 text-foreground hover:bg-accent/20 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/60'

};



const safeNumber = (value: number | null | undefined, fallback = 'Ã¢ÂÂ') => {
...
const formatCompact = (value: number | null | undefined, fallback = 'Ã¢ÂÂ') => {
...
const formatCurrency = (value: number | null | undefined, fallback = 'Ã¢ÂÂ') => {
...
const formatPct = (value: number | null | undefined, fallback = 'Ã¢ÂÂ') => {
  ...
  const tableColumns: Column<any>[] = useMemo(
    ...
    () => [
...

      {
        ...
        Cell: ({ value }) => (Array.isArray(value) ? value.join(', ') : value || 'Ã¢ÂÂ')
      ...
      <div className="space-y-6 p-6 max-w-7xl mx-auto text-foreground">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {[
              ...
              <button
                ...
                className={`${UI.pill} ${range.preset === p.preset ? UI.pillActive : ''}`}
          ...
          {loading ? (
            ...
            <>
              ...
              <KpiCard
                ...
                value={kpis ? `${kpis.adsGenerated}` : 'Ã¢ÂÂ'}

                delta={0}

                icon={<Rocket size={16} />}

                hint="im gewÃÂ¤hlten Zeitraum"
              ...
              <KpiCard
                ...
                value={kpis ? `${kpis.strategiesCreated}` : 'Ã¢ÂÂ'}
              ...
              <KpiCard
                ...
                value={kpis ? `${kpis.analysesRun}` : 'Ã¢ÂÂ'}
              ...
              <KpiCard
                ...
                value={kpis ? `${kpis.creditsUsed}` : 'Ã¢ÂÂ'}
              ...
              <KpiCard
                ...
                onClick={() => openDrawer('Iteration Velocity', <p>Ads pro Tag im gewÃÂ¤hlten Zeitraum.</p>)}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <CardShell className="lg:col-span-2" title="Activity Feed">
            ...
            {loading ? (
              ...
              <p className="text-sm text-white/50">Keine AktivitÃÂ¤ten im Zeitraum.</p>
          ...
          <CardShell className="lg:col-span-2" title="Assets">
            ...
            {tableRows.length === 0 && !loading && (
              ...
              <div className="mt-3 rounded-xl border border-white/10 bg-white/5 px-3 py-3 text-sm text-white/60">
                ...
                No assets in this view Ã¢ÂÂ generate your first Ad Variant oder Strategy.
        ...
        {loading && (
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white/80">
            ...
            <RefreshCw className="mr-2 inline animate-spin" size={16} /> LÃÂ¤dt...
