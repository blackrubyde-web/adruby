          ...
          >
            <div className="max-w-2xl mx-auto">
              ...
              <div className="flex items-center space-x-4 mb-8">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-foreground">Credit-Zahlung</h1>
                  <p className="text-muted-foreground">
                    {paymentData?.packageName} -{" "}
                    {creditService?.formatCredits(paymentData?.credits)} Credits
                  </p>
                </div>
              </div>
              ...
              <StripePaymentForm
                ...
                confirmButtonText={`${stripeService?.formatPrice(
                  paymentData?.amount,
      ...
      >
        <div className="max-w-6xl mx-auto space-y-8">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Aktuelle Verfügbarkeit</p>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-muted-foreground">vom Standard-Paket</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          {activeTab === "packages" && (
            ...
            >
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-4">Credit-Pakete kaufen</h3>
                    ...
                    >
                      ...
                      <div className="text-center space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-muted-foreground">{pkg?.pricePerCredit}€ pro Credit</p>
                        </div>
              ...
              <div className="bg-muted/50 rounded-lg p-6">
                <h4 className="font-semibold text-foreground mb-4">Credit-Verbrauch pro Aktion</h4>
          ...
          {activeTab === "history" && (
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.4 }}
            >
              <h3 className="text-lg font-semibold text-foreground">Credit-Verlauf</h3>
              <div className="bg-card border border-border rounded-lg">
                {creditHistory?.length === 0 ? (
                  <div className="p-8 text-center">
                    <Icon name="History" size={48} className="text-muted-foreground mx-auto mb-4" />
                    <p className="text-muted-foreground">Noch keine Credit-Transaktionen vorhanden</p>
                  </div>
                ) : (
          ...
          {activeTab === "payments" && (
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.4 }}
            >
              <h3 className="text-lg font-semibold text-foreground">Zahlungshistorie</h3>
              <div className="bg-card border border-border rounded-lg">
                {paymentHistory?.length === 0 ? (
                  <div className="p-8 text-center">
                    <Icon name="CreditCard" size={48} className="text-muted-foreground mx-auto mb-4" />
                    <p className="text-muted-foreground">Noch keine Zahlungen vorhanden</p>
                  </div>
                ) : (
                  <div className="divide-y divide-border">
                    {paymentHistory?.map((payment, index) => (
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="font-medium text-sm">{payment?.packageName}</p>
                            <p className="text-xs text-muted-foreground">Bestellung #{payment?.orderNumber}</p>
                            <p className="text-xs text-muted-foreground">{formatDate(payment?.createdAt)}</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="font-semibold">{payment?.amountFormatted}</p>
