    ...
    if (currentView === 'landing') {
        return (
            <div className="flex-1 flex flex-col items-center justify-center min-h-screen relative overflow-hidden bg-gradient-to-br from-zinc-50 via-white to-zinc-100 dark:from-zinc-950 dark:via-zinc-900 dark:to-black">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-rose-50/50 via-transparent to-red-50/50 dark:from-rose-900/20 dark:via-zinc-950/50 dark:to-transparent"></div>
                <div className="absolute -top-[20%] -right-[10%] w-[800px] h-[800px] bg-rose-200/30 dark:bg-rose-600/10 rounded-full blur-[120px] animate-pulse-slow"></div>
                <div className="absolute top-[40%] -left-[10%] w-[600px] h-[600px] bg-red-200/30 dark:bg-red-600/10 rounded-full blur-[100px] animate-pulse-slower"></div>
                ...
                <div className="relative z-10 flex flex-col items-center max-w-2xl px-6 text-center animate-in fade-in zoom-in-95 duration-1000">
                    <div className="mb-8 relative group">
                        <div className="absolute inset-0 bg-gradient-to-r from-rose-400 to-red-500 dark:from-rose-600 dark:to-red-600 blur-2xl opacity-20 group-hover:opacity-40 transition-opacity duration-500 rounded-full"></div>
                        <div className="relative p-8 bg-white/80 dark:bg-zinc-900/50 backdrop-blur-xl border border-zinc-200/50 dark:border-white/5 rounded-[32px] shadow-2xl group-hover:scale-105 transition-transform duration-500">
                            <Palette className="w-16 h-16 text-rose-600 dark:text-white drop-shadow-[0_0_15px_rgba(225,29,72,0.5)] dark:drop-shadow-[0_0_15px_rgba(255,255,255,0.5)]" />
                        </div>
                    </div>

                    <h1 className="text-6xl md:text-7xl font-black tracking-tighter text-zinc-900 dark:text-white mb-6 drop-shadow-2xl">
                        AdRuby <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-red-600 dark:from-rose-400 dark:to-red-400">Studio</span>
                    </h1>
                    ...
                    <button
                        ...
                        className="group relative px-12 py-5 bg-gradient-to-r from-rose-600 to-red-600 text-white rounded-2xl font-black text-lg tracking-wide shadow-[0_0_40px_-10px_rgba(225,29,72,0.5)] hover:shadow-[0_0_60px_-15px_rgba(225,29,72,0.7)] hover:scale-105 active:scale-95 transition-all duration-300 overflow-hidden"
                    >
