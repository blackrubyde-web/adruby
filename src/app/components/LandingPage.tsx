  ...
  return (
    <div className="min-h-screen w-full bg-background landing-page">
      ...
      {/* ============================================
            ...
            ============================================ */}
      <div className="relative min-h-[100dvh] flex flex-col items-center justify-center pt-24 pb-12 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[1400px] px-6 sm:px-8 flex flex-col items-center text-center space-y-8 sm:space-y-12">
