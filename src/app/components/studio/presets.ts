...
export const MODULE_PRESETS: ModulePreset[] = [
    ...
    },
    {
        ...
        layerDetails: { type: 'text', text: 'MASSIVE HOLZDESIGNER', width: 800, fontSize: 72, fontWeight: 900, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'center' }
    },
    // --- SAAS / TECH ---
    {
        ...
        layerDetails: { type: 'text', text: '✓ Unlimited Projects\n✓ AI Generation\n✓ Auto Export', width: 400, fontSize: 24, fontWeight: 600, fontFamily: 'Inter', color: '#3b82f6', fill: '#3b82f6', align: 'left', lineHeight: 1.5 }
    },
    {
        id: 'saas_cta_modern',
    ...
    // --- COACHING ---
    {
        ...
        layerDetails: { type: 'text', text: '"Success is not the key to happiness. Happiness is the key to success."', width: 600, fontSize: 32, fontWeight: 400, fontStyle: 'italic', fontFamily: 'Playfair Display', color: '#1e293b', fill: '#1e293b', align: 'center' }
    },
    {
        id: 'coach_cta_join',
        label: 'Join Program',
    ...
    },
    {
        ...
        tags: ['benefits', 'perks'],
        layerDetails: { type: 'text', text: '💰 Competitive Salary\n🏠 Remote Work\n📈 Career Growth\n🎯 Equity Options', width: 400, fontSize: 22, fontWeight: 600, fontFamily: 'Inter', color: '#10b981', fill: '#10b981', align: 'left', lineHeight: 1.6 }
    },
    // --- REAL ESTATE ---
    {
    ...
    },
    {
        ...
        layerDetails: { type: 'text', text: '🛏 4 Bedrooms  •  🚿 2 Baths  •  📐 180m²', width: 600, fontSize: 24, fontWeight: 600, fontFamily: 'Inter', color: '#475569', fill: '#475569', align: 'center' }
    },
    {
        id: 'realestate_cta',
        label: 'Book Viewing',
    ...
    },
    {
        ...
        layerDetails: { type: 'text', text: '⭐⭐⭐⭐⭐ 4.9 (2.4k Reviews)', width: 400, fontSize: 22, fontWeight: 700, fontFamily: 'Inter', color: '#facc15', fill: '#facc15', align: 'center' }
    },
    // --- FITNESS / GYM ---
    {
    ...
    },
    {
        ...
        layerDetails: { type: 'text', text: '🔥 -15kg in 90 Days\n💪 +40% Strength\n❤️ 98% Success Rate', width: 400, fontSize: 24, fontWeight: 700, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'left', lineHeight: 1.5 }
    },
    // --- EVENT / PARTY ---
    {
        id: 'event_date_badge',
    ...
    },
    {
        ...
        layerDetails: { type: 'text', text: 'NEW YEAR\'S EVE\nBASH 2025', width: 700, fontSize: 80, fontWeight: 900, fontFamily: 'Oswald', color: '#ec4899', fill: '#ec4899', align: 'center', lineHeight: 1.0 }
    },
    // --- FINANCE / LEGAL ---
    {
    ...
    },
    {
        ...
        layerDetails: { type: 'text', text: 'Secure Your\nFinancial Future.', width: 600, fontSize: 56, fontWeight: 800, fontFamily: 'Inter', color: '#0f172a', fill: '#0f172a', align: 'left', lineHeight: 1.1 }
    },
    // --- TRUST & BADGES ---
    {
        id: 'badge_guarantee',
    ...
    // --- FRAMES (Simulated with CTA/Text) ---
    {
        ...
        layerDetails: { type: 'text', text: '⭐⭐⭐⭐⭐\n"This product changed my life! Highly recommended."\n- Sarah J.', width: 500, fontSize: 24, fontWeight: 500, fontFamily: 'Inter', color: '#1f2937', fill: '#1f2937', align: 'center', lineHeight: 1.4 }
    }
];
...
export const AD_TEMPLATES: AdTemplate[] = [
    // --- CRAFT ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'title', type: 'text', name: 'Headline', x: 90, y: 150, width: 900, height: 200, visible: true, locked: false, zIndex: 10, text: 'ECHTES HANDWERK.\nZEITLOSES DESIGN.', fontSize: 80, fontWeight: 900, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'left', rotation: 0, opacity: 1, lineHeight: 1.1, letterSpacing: -2 },
    ...
    // --- SAAS ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'title', type: 'text', name: 'Headline', x: 100, y: 750, width: 880, height: 100, visible: true, locked: false, zIndex: 10, text: 'Automate Everything.', fontSize: 72, fontWeight: 800, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.1, letterSpacing: -3 },
    ...
    // --- REAL ESTATE ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'features', type: 'text', name: 'Features', x: 60, y: 860, width: 600, height: 50, visible: true, locked: false, zIndex: 10, text: '🛏 5 Beds  •  🚿 3 Baths  •  📐 320m²', fontSize: 22, fontWeight: 600, fontFamily: 'Inter', color: '#94a3b8', fill: '#94a3b8', align: 'left', rotation: 0, opacity: 1, lineHeight: 1.2, letterSpacing: 0 },
    ...
    // --- RESTAURANT ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'title', type: 'text', name: 'Dish Name', x: 60, y: 800, width: 800, height: 120, visible: true, locked: false, zIndex: 10, text: 'Signature\nPasta Carbonara', fontSize: 60, fontWeight: 900, fontFamily: 'Playfair Display', color: '#FFFFFF', fill: '#FFFFFF', align: 'left', rotation: 0, opacity: 1, lineHeight: 1.0, letterSpacing: -1 },
    ...
    // --- FITNESS ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'title', type: 'text', name: 'Headline', x: 60, y: 200, width: 960, height: 200, visible: true, locked: false, zIndex: 10, text: 'TRANSFORM\nYOUR BODY', fontSize: 100, fontWeight: 900, fontFamily: 'Oswald', color: '#FFFFFF', fill: '#FFFFFF', align: 'left', rotation: 0, opacity: 1, lineHeight: 0.95, letterSpacing: -2 },
    ...
    // --- EVENT ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'title', type: 'text', name: 'Event Title', x: 90, y: 300, width: 900, height: 300, visible: true, locked: false, zIndex: 10, text: "NEW YEAR'S\nEVE BASH", fontSize: 100, fontWeight: 900, fontFamily: 'Oswald', color: '#ec4899', fill: '#ec4899', align: 'center', rotation: 0, opacity: 1, lineHeight: 0.9, letterSpacing: 0 },
    ...
    // --- COMMERCE ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'title', type: 'text', name: 'Sale Title', x: 190, y: 300, width: 700, height: 200, visible: true, locked: false, zIndex: 10, text: 'SUMMER\nSALE', fontSize: 90, fontWeight: 900, fontFamily: 'Playfair Display', color: '#000000', fill: '#000000', align: 'center', rotation: 0, opacity: 1, lineHeight: 0.9, letterSpacing: -2 },
    ...
    // --- COACHING ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'title', type: 'text', name: 'Headline', x: 60, y: 650, width: 900, height: 200, visible: true, locked: false, zIndex: 10, text: 'Master Your\nMindset.', fontSize: 80, fontWeight: 400, fontFamily: 'Playfair Display', fontStyle: 'italic', color: '#FFFFFF', fill: '#FFFFFF', align: 'left', rotation: 0, opacity: 1, lineHeight: 0.9, letterSpacing: -1, shadowColor: '#000000', shadowBlur: 20 },
    ...
    // --- JOB ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'title', type: 'text', name: 'Headline', x: 90, y: 200, width: 900, height: 200, visible: true, locked: false, zIndex: 10, text: 'WE ARE\nHIRING', fontSize: 110, fontWeight: 900, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'center', rotation: 0, opacity: 1, lineHeight: 0.85, letterSpacing: -4 },
                { id: 'role', type: 'text', name: 'Roles', x: 240, y: 500, width: 600, height: 200, visible: true, locked: false, zIndex: 10, text: '• Senior Designer\n• Frontend Dev\n• Product Manager', fontSize: 32, fontWeight: 600, fontFamily: 'Inter', color: '#9ca3af', fill: '#9ca3af', align: 'left', rotation: 0, opacity: 1, lineHeight: 1.6, letterSpacing: 0 },
    ...
    // --- FINANCE ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'title', type: 'text', name: 'Headline', x: 450, y: 300, width: 580, height: 200, visible: true, locked: false, zIndex: 10, text: 'Secure Your\nFinancial Future.', fontSize: 64, fontWeight: 800, fontFamily: 'Inter', color: '#0f172a', fill: '#0f172a', align: 'left', rotation: 0, opacity: 1, lineHeight: 1.1, letterSpacing: -2 },
    ...
    // --- COMMERCE / DROPSHIPPING ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'headline', type: 'text', name: 'Headline', x: 60, y: 80, width: 960, height: 150, visible: true, locked: false, zIndex: 10, text: 'PROBLEM?\nSOLVED.', fontSize: 100, fontWeight: 900, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'left', rotation: 0, opacity: 1, lineHeight: 0.9, letterSpacing: -4, shadowColor: '#000000', shadowBlur: 20 },
    ...
    // --- GASTRONOMY ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'title', type: 'text', name: 'Headline', x: 60, y: 800, width: 900, height: 150, visible: true, locked: false, zIndex: 10, text: 'ULTIMATE\nCHEESEBURGER', fontSize: 80, fontWeight: 900, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'left', rotation: 0, opacity: 1, lineHeight: 0.9, letterSpacing: -2, shadowColor: '#000000', shadowBlur: 10 },
    ...
    // --- SAAS B2B ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'title', type: 'text', name: 'Headline', x: 0, y: 80, width: 1080, height: 150, visible: true, locked: false, zIndex: 10, text: 'Scale Your Business\nWith AI Analytics', fontSize: 72, fontWeight: 700, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.1, letterSpacing: -2 },
    ...
    // --- COACHING ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'eyebrow', type: 'text', name: 'Eyebrow', x: 80, y: 200, width: 500, height: 50, visible: true, locked: false, zIndex: 10, text: 'FREE MASTERCLASS', fontSize: 20, fontWeight: 800, fontFamily: 'Inter', color: '#b45309', fill: '#b45309', align: 'left', rotation: 0, opacity: 1, lineHeight: 1, letterSpacing: 2 },
                { id: 'title', type: 'text', name: 'Headline', x: 80, y: 270, width: 550, height: 300, visible: true, locked: false, zIndex: 10, text: 'How To Build\nA 6-Figure\nCoaching Biz', fontSize: 72, fontWeight: 900, fontFamily: 'Inter', color: '#1e293b', fill: '#1e293b', align: 'left', rotation: 0, opacity: 1, lineHeight: 1.0, letterSpacing: -2 },
    ...
    // --- UGC TESTIMONIAL STYLE ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'stars', type: 'text', name: 'Star Rating', x: 60, y: 700, width: 400, height: 50, visible: true, locked: false, zIndex: 10, text: '⭐⭐⭐⭐⭐', fontSize: 36, fontWeight: 400, fontFamily: 'Inter', color: '#facc15', fill: '#facc15', align: 'left', rotation: 0, opacity: 1, lineHeight: 1 },
                { id: 'quote', type: 'text', name: 'Testimonial', x: 60, y: 760, width: 960, height: 200, visible: true, locked: false, zIndex: 10, text: '"This completely changed my routine. I can\'t imagine life without it anymore!"', fontSize: 36, fontWeight: 500, fontFamily: 'Inter', fontStyle: 'italic', color: '#1e293b', fill: '#1e293b', align: 'left', rotation: 0, opacity: 1, lineHeight: 1.3 },
                { id: 'name', type: 'text', name: 'Customer Name', x: 60, y: 950, width: 400, height: 40, visible: true, locked: false, zIndex: 10, text: '— Sarah M., verified buyer', fontSize: 20, fontWeight: 600, fontFamily: 'Inter', color: '#64748b', fill: '#64748b', align: 'left', rotation: 0, opacity: 1, lineHeight: 1 },
    ...
    // --- PROBLEM-SOLUTION STYLE ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'problem_icon', type: 'text', name: 'Problem Emoji', x: 150, y: 250, width: 240, height: 200, visible: true, locked: false, zIndex: 10, text: '😫', fontSize: 150, fontWeight: 400, fontFamily: 'Inter', color: '#000000', fill: '#000000', align: 'center', rotation: 0, opacity: 1, lineHeight: 1 },
                { id: 'solution_icon', type: 'text', name: 'Solution Emoji', x: 690, y: 250, width: 240, height: 200, visible: true, locked: false, zIndex: 10, text: '🥳', fontSize: 150, fontWeight: 400, fontFamily: 'Inter', color: '#000000', fill: '#000000', align: 'center', rotation: 0, opacity: 1, lineHeight: 1 },
                { id: 'problem_text', type: 'text', name: 'Problem Text', x: 40, y: 480, width: 460, height: 300, visible: true, locked: false, zIndex: 10, text: 'Tired of\nwasting money\non products\nthat don\'t work?', fontSize: 40, fontWeight: 700, fontFamily: 'Inter', color: '#dc2626', fill: '#dc2626', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.2 },
                { id: 'solution_text', type: 'text', name: 'Solution Text', x: 580, y: 480, width: 460, height: 300, visible: true, locked: false, zIndex: 10, text: 'Finally,\na solution\nthat actually\nworks.', fontSize: 40, fontWeight: 700, fontFamily: 'Inter', color: '#16a34a', fill: '#16a34a', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.2 },
    ...
    // --- FEATURE SPOTLIGHT STYLE ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'headline', type: 'text', name: 'Headline', x: 60, y: 780, width: 960, height: 120, visible: true, locked: false, zIndex: 10, text: 'The Future of\nProductivity', fontSize: 72, fontWeight: 900, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.0, letterSpacing: -3 },
    ...
    // --- BOLD HEADLINE STYLE (Magic Spoon inspired) ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'line1', type: 'text', name: 'Line 1', x: 60, y: 80, width: 960, height: 80, visible: true, locked: false, zIndex: 10, text: 'LESS SUGAR.', fontSize: 72, fontWeight: 900, fontFamily: 'Inter', color: '#0f172a', fill: '#0f172a', align: 'center', rotation: 0, opacity: 1, lineHeight: 1, letterSpacing: -2 },
                { id: 'line2', type: 'text', name: 'Line 2', x: 60, y: 160, width: 960, height: 80, visible: true, locked: false, zIndex: 10, text: 'MORE FLAVOR.', fontSize: 72, fontWeight: 900, fontFamily: 'Inter', color: '#dc2626', fill: '#dc2626', align: 'center', rotation: 0, opacity: 1, lineHeight: 1, letterSpacing: -2 },
                { id: 'line3', type: 'text', name: 'Line 3', x: 60, y: 240, width: 960, height: 80, visible: true, locked: false, zIndex: 10, text: 'ALL THE FUN.', fontSize: 72, fontWeight: 900, fontFamily: 'Inter', color: '#2563eb', fill: '#2563eb', align: 'center', rotation: 0, opacity: 1, lineHeight: 1, letterSpacing: -2 },
    ...
    // --- SOCIAL PROOF / TRUST STYLE ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'reviews', type: 'text', name: 'Reviews', x: 200, y: 720, width: 680, height: 80, visible: true, locked: false, zIndex: 10, text: '⭐⭐⭐⭐⭐ 4.9 • 12,847 Reviews', fontSize: 32, fontWeight: 700, fontFamily: 'Inter', color: '#16a34a', fill: '#16a34a', align: 'center', rotation: 0, opacity: 1, lineHeight: 1 },
    ...
    // --- LIMITED TIME OFFER STYLE ---
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'discount', type: 'text', name: 'Discount', x: 60, y: 300, width: 960, height: 300, visible: true, locked: false, zIndex: 10, text: '70%\nOFF', fontSize: 200, fontWeight: 900, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'center', rotation: 0, opacity: 1, lineHeight: 0.85, letterSpacing: -10 },
                { id: 'subtitle', type: 'text', name: 'Subtitle', x: 140, y: 680, width: 800, height: 60, visible: true, locked: false, zIndex: 10, text: 'Our biggest sale ever. Don\'t miss out.', fontSize: 32, fontWeight: 500, fontFamily: 'Inter', color: '#fecaca', fill: '#fecaca', align: 'center', rotation: 0, opacity: 1, lineHeight: 1 },
    ...
    // 1. UGC TESTIMONIAL  (4x CTR, 50% lower CPC)
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'rating', type: 'text', name: 'Star Rating', role: 'social_proof', x: 60, y: 700, width: 400, height: 60, visible: true, locked: false, zIndex: 10, text: '⭐⭐⭐⭐⭐', fontSize: 48, fontWeight: 400, fontFamily: 'Inter', color: '#facc15', fill: '#facc15', align: 'left', rotation: 0, opacity: 1, lineHeight: 1 },
                { id: 'quote', type: 'text', name: 'Testimonial', role: 'description', x: 60, y: 780, width: 960, height: 160, visible: true, locked: false, zIndex: 10, text: '"I was skeptical but this actually works! My skin has never looked better."', fontSize: 34, fontWeight: 500, fontFamily: 'Inter', fontStyle: 'italic', color: '#1e293b', fill: '#1e293b', align: 'left', rotation: 0, opacity: 1, lineHeight: 1.3 },
    ...
    // 2. HOOK + PROBLEM-AGITATE-SOLVE
    {
        ...
        document: {
            backgroundColor: '#0f172a',
            layers: [
                { id: 'hook', type: 'text', name: 'Hook', role: 'headline', x: 60, y: 100, width: 960, height: 180, visible: true, locked: false, zIndex: 10, text: 'STOP\nSCROLLING', fontSize: 110, fontWeight: 900, fontFamily: 'Inter', color: '#fbbf24', fill: '#fbbf24', align: 'center', rotation: 0, opacity: 1, lineHeight: 0.9, letterSpacing: -4 },
                { id: 'problem', type: 'text', name: 'Problem', role: 'subheadline', x: 90, y: 350, width: 900, height: 120, visible: true, locked: false, zIndex: 10, text: 'Tired of products that promise results but never deliver?', fontSize: 40, fontWeight: 700, fontFamily: 'Inter', color: '#ef4444', fill: '#ef4444', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.2 },
                { id: 'agitate', type: 'text', name: 'Agitate', role: 'description', x: 90, y: 500, width: 900, height: 160, visible: true, locked: false, zIndex: 10, text: 'You\'ve wasted hundreds on "miracle" solutions. Each one disappoints.', fontSize: 32, fontWeight: 500, fontFamily: 'Inter', color: '#94a3b8', fill: '#94a3b8', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.4 },
                { id: 'solution', type: 'text', name: 'Solution', role: 'social_proof', x: 90, y: 700, width: 900, height: 100, visible: true, locked: false, zIndex: 10, text: 'This actually works. 12,847 5-star reviews prove it.', fontSize: 34, fontWeight: 700, fontFamily: 'Inter', color: '#22c55e', fill: '#22c55e', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.3 },
    ...
    // 3. "UGLY AD" POST-IT STYLE (Pattern Interrupt)
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'handwritten', type: 'text', name: 'Handwritten Text', x: 140, y: 220, width: 800, height: 500, visible: true, locked: false, zIndex: 10, text: 'Seriously\ntry this!!\n\nChanged my life\n\n12k+ ⭐⭐⭐⭐⭐', fontSize: 64, fontWeight: 400, fontFamily: 'Caveat', color: '#0f172a', fill: '#0f172a', align: 'center', rotation: -1, opacity: 1, lineHeight: 1.3, letterSpacing: 0 },
                { id: 'arrow', type: 'text', name: 'Arrow', x: 750, y: 650, width: 200, height: 100, visible: true, locked: false, zIndex: 15, text: '↓', fontSize: 120, fontWeight: 400, fontFamily: 'Inter', color: '#dc2626', fill: '#dc2626', align: 'center', rotation: 15, opacity: 1, lineHeight: 1 },
    ...
    // 4. BEFORE/AFTER SPLIT SCREEN
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'stats', type: 'text', name: 'Social Proof', role: 'social_proof', x: 200, y: 900, width: 680, height: 70, visible: true, locked: false, zIndex: 10, text: '47,291 transformations in 2024', fontSize: 32, fontWeight: 700, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'center', rotation: 0, opacity: 1, lineHeight: 1, shadowColor: '#000000', shadowBlur: 20 },
    ...
    // 5. SOCIAL PROOF OVERLOAD
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'reviews', type: 'text', name: 'Reviews', role: 'social_proof', x: 180, y: 720, width: 720, height: 70, visible: true, locked: false, zIndex: 10, text: '⭐⭐⭐⭐⭐ 4.9/5 • 18,394 Reviews', fontSize: 36, fontWeight: 800, fontFamily: 'Inter', color: '#16a34a', fill: '#16a34a', align: 'center', rotation: 0, opacity: 1, lineHeight: 1 },
                ...
                { id: 'urgency', type: 'text', name: 'Urgency', role: 'description', x: 240, y: 900, width: 600, height: 50, visible: true, locked: false, zIndex: 10, text: '🔥 2,847 sold in the last 24 hours', fontSize: 22, fontWeight: 700, fontFamily: 'Inter', color: '#dc2626', fill: '#dc2626', align: 'center', rotation: 0, opacity: 1, lineHeight: 1 },
    ...
    // 6. FEATURE SPOTLIGHT GRID
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'headline', type: 'text', name: 'Headline', x: 90, y: 800, width: 900, height: 120, visible: true, locked: false, zIndex: 10, text: 'Work Smarter,\nNot Harder', fontSize: 72, fontWeight: 900, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.0, letterSpacing: -3 },
    ...
    // 7. FOMO SCARCITY
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'discount', type: 'text', name: 'Discount', x: 90, y: 280, width: 900, height: 320, visible: true, locked: false, zIndex: 10, text: '70%\nOFF', fontSize: 220, fontWeight: 900, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'center', rotation: 0, opacity: 1, lineHeight: 0.85, letterSpacing: -10 },
                { id: 'stock', type: 'text', name: 'Stock Counter', x: 240, y: 650, width: 600, height: 70, visible: true, locked: false, zIndex: 10, text: '⚠️ Only 7 left in stock', fontSize: 36, fontWeight: 700, fontFamily: 'Inter', color: '#fecaca', fill: '#fecaca', align: 'center', rotation: 0, opacity: 1, lineHeight: 1 },
                { id: 'subtitle', type: 'text', name: 'Subtitle', x: 140, y: 750, width: 800, height: 60, visible: true, locked: false, zIndex: 10, text: 'Biggest sale ever. Don\'t miss out.', fontSize: 32, fontWeight: 500, fontFamily: 'Inter', color: '#fee2e2', fill: '#fee2e2', align: 'center', rotation: 0, opacity: 1, lineHeight: 1 },
    ...
    // 8. QUESTION HOOK
    {
        ...
        document: {
            ...
            layers: [
                { id: 'question', type: 'text', name: 'Hook Question', x: 90, y: 150, width: 900, height: 300, visible: true, locked: false, zIndex: 10, text: 'Still wasting\nmoney on\nproducts that\ndon\'t work?', fontSize: 80, fontWeight: 900, fontFamily: 'Inter', color: '#fbbf24', fill: '#fbbf24', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.1, letterSpacing: -3 },
                { id: 'answer', type: 'text', name: 'Answer', x: 140, y: 520, width: 800, height: 180, visible: true, locked: false, zIndex: 10, text: 'This is different. 94% of users see results in 7 days.', fontSize: 42, fontWeight: 600, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.3 },
                { id: 'proof', type: 'text', name: 'Social Proof', x: 240, y: 740, width: 600, height: 80, visible: true, locked: false, zIndex: 10, text: '⭐⭐⭐⭐⭐ 4.9 (14.2k reviews)', fontSize: 32, fontWeight: 700, fontFamily: 'Inter', color: '#22c55e', fill: '#22c55e', align: 'center', rotation: 0, opacity: 1, lineHeight: 1 },
    ...
    // 9. BENEFIT STACK
    {
        ...
        document: {
            backgroundColor: '#f8fafc',
            layers: [
                { id: 'headline', type: 'text', name: 'Headline', x: 90, y: 100, width: 900, height: 140, visible: true, locked: false, zIndex: 10, text: 'Everything You\nNeed. Nothing You Don\'t.', fontSize: 62, fontWeight: 900, fontFamily: 'Inter', color: '#0f172a', fill: '#0f172a', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.1, letterSpacing: -2 },
                { id: 'benefits', type: 'text', name: 'Benefits List', x: 140, y: 300, width: 800, height: 480, visible: true, locked: false, zIndex: 10, text: '✅ Unlimited projects & exports\n✅ AI-powered automation\n✅ Real-time collaboration\n✅ Advanced analytics dashboard\n✅ Priority support 24/7\n✅ 99.9% uptime guarantee\n✅ No hidden fees ever', fontSize: 34, fontWeight: 600, fontFamily: 'Inter', color: '#1e293b', fill: '#1e293b', align: 'left', rotation: 0, opacity: 1, lineHeight: 1.8, letterSpacing: 0 },
    ...
    // 10. INFLUENCER/CREATOR UGC
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'caption', type: 'text', name: 'Caption', role: 'description', x: 60, y: 850, width: 960, height: 180, visible: true, locked: false, zIndex: 10, text: 'Been using this for 3 weeks and I\'m obsessed. Link in bio ⬇️', fontSize: 38, fontWeight: 600, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'left', rotation: 0, opacity: 1, lineHeight: 1.3, shadowColor: '#000000', shadowBlur: 30 },
    ...
    // 11. PAIN POINT CALLOUT
    {
        ...
        document: {
            backgroundColor: '#fef3c7',
            layers: [
                { id: 'pain', type: 'text', name: 'Pain Point', role: 'headline', x: 90, y: 180, width: 900, height: 280, visible: true, locked: false, zIndex: 10, text: 'Spending 10 hours\na week on tasks\nthat could be\nautomated?', fontSize: 68, fontWeight: 900, fontFamily: 'Inter', color: '#dc2626', fill: '#dc2626', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.15, letterSpacing: -2 },
                { id: 'scenario', type: 'text', name: 'Scenario', role: 'subheadline', x: 140, y: 520, width: 800, height: 160, visible: true, locked: false, zIndex: 10, text: 'You\'re burning out doing repetitive work while competitors automate everything.', fontSize: 36, fontWeight: 600, fontFamily: 'Inter', color: '#78350f', fill: '#78350f', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.4 },
                { id: 'solution', type: 'text', name: 'Solution', role: 'description', x: 140, y: 730, width: 800, height: 100, visible: true, locked: false, zIndex: 10, text: 'Get back 40+ hours/month with automation.', fontSize: 38, fontWeight: 700, fontFamily: 'Inter', color: '#000000', fill: '#000000', align: 'center', rotation: 0, opacity: 1, lineHeight: 1.3 },
    ...
    // 12. BOLD HEADLINE STATEMENT
    {
        ...
        document: {
            ...
            layers: [
                ...
                { id: 'line1', type: 'text', name: 'Line 1', role: 'headline', x: 90, y: 80, width: 900, height: 90, visible: true, locked: false, zIndex: 10, text: 'BETTER RESULTS.', fontSize: 76, fontWeight: 900, fontFamily: 'Inter', color: '#FFFFFF', fill: '#FFFFFF', align: 'center', rotation: 0, opacity: 1, lineHeight: 1, letterSpacing: -2 },
                { id: 'line2', type: 'text', name: 'Line 2', role: 'subheadline', x: 90, y: 180, width: 900, height: 90, visible: true, locked: false, zIndex: 10, text: 'LESS EFFORT.', fontSize: 76, fontWeight: 900, fontFamily: 'Inter', color: '#22c55e', fill: '#22c55e', align: 'center', rotation: 0, opacity: 1, lineHeight: 1, letterSpacing: -2 },
                { id: 'line3', type: 'text', name: 'Line 3', role: 'description', x: 90, y: 280, width: 900, height: 90, visible: true, locked: false, zIndex: 10, text: 'GUARANTEED.', fontSize: 76, fontWeight: 900, fontFamily: 'Inter', color: '#fbbf24', fill: '#fbbf24', align: 'center', rotation: 0, opacity: 1, lineHeight: 1, letterSpacing: -2 },
